...
// // // // // //         <lottie-player
// // // // // //           src="https://assets8.lottiefiles.com/packages/lf20_jcikwtux.json" // Chat-based animation URL
...
// // // // //                 <input
// // // // //                   type="email"
// // // // //                   className="input w-full pl-10 py-2 border dark:bg-[#1e1e1e] bg-gray-100 focus:ring-2 focus:ring-primary"
// // // // //                   placeholder="Enter Email address"
// // // // //                   value={formData.email}
// // // // //                   onChange={(e) =>
// // // // //                     setFormData({ ...formData, email: e.target.value })
...
// // // // //             <button
// // // // //               type="submit"
// // // // //               className="w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-purple-600 hover:to-blue-500 text-white rounded-lg shadow-md transition-all duration-300"
// // // // //               disabled={isLoggingIn}
// // // // //             >
// // // // //               {isLoggingIn ? (
// // // // //                 <>
...
// // // // //             <Typewriter options={{
// // // // //                 strings: ['Connect Instantly, Communicate Effortlessly.'],
// // // // //                 autoStart: true,
// // // // //                 loop: true,
// // // // //               }}
// // // // //             />
...
// // // // //       {/* 🟦 Gradient Background */}
// // // // //       <div className="absolute inset-0 -z-10 bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-[#0e0e0e] dark:via-[#1a1a1a] dark:to-black" />

// // // // //       {/* Left Side - Login Form */}
// // // // //       <div className="flex flex-col justify-center items-center p-6 sm:p-12">
// // // // //         <div className="w-full max-w-md space-y-8 bg-white/60 dark:bg-[#1e1e1e]/60 backdrop-blur-lg rounded-2xl shadow-xl p-10">
// // // // //           {/* Logo & Welcome */}
// // // // //           <div className="text-center mb-8">
// // // // //             <div className="flex flex-col items-center gap-2 group">
...
// // // // //         ></lottie-player>
// // // // //         <div className="text-center mt-4">
// // // // //           <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 text-lg font-semibold">
...
// // // //   return (
// // // //     <div className="h-screen grid lg:grid-cols-2 relative overflow-hidden">
// // // //       <div className="absolute inset-0 -z-10 bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-[#0e0e0e] dark:via-[#1a1a1a] dark:to-black"></div>
// // // //       {/* Left Side - Form */}
// // // //       <div className="flex flex-col justify-center items-center p-6 sm:p-12">
// // // //         <div className="w-full max-w-md space-y-8 bg-white/60 dark:bg-[#1e1e1e]/60 backdrop-blur-lg rounded-2xl shadow-xl p-10">
// // // //           {/* Logo */}
...
// // // //                 <input
// // // //                   type="email"
// // // //                   className="input w-full pl-10 py-2 dark:bg-[#1e1e1e] bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary border-none rounded-xl"
// // // //                   placeholder="Enter Email address"
// // // //                   value={formData.email}
// // // //                   onChange={(e) =>
// // // //                     setFormData({ ...formData, email: e.target.value })
...
// // //       >
// // //         <div className="w-full max-w-md space-y-8 bg-white/60 dark:bg-[#1e1e1e]/60 backdrop-blur-lg rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.1)] border border-white/20 p-10">
// // //           {/* Logo */}
// // //           <div className="text-center mb-8">
// // //             <div className="flex flex-col items-center gap-2 group">
// // //               <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
...
// // //                 <input
// // //                   type="email"
// // //                   className="peer input w-full pl-10 py-2 border dark:bg-[#1e1e1e] bg-gray-100 focus:ring-2 focus:ring-primary"
// // //                   placeholder="Enter Email address"
// // //                   value={formData.email}
...
// //   return (
// //     <div className="h-screen grid lg:grid-cols-2 relative overflow-hidden">
// //       <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,rgba(99,102,241,0.1),transparent_25%),radial-gradient(circle_at_80%_80%,rgba(168,85,247,0.1),transparent_25%)] bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-[#0e0e0e] dark:via-[#1a1a1a] dark:to-black"></div>
// //       {/* Left Side - Form */}
// //       <motion.div
// //         initial={{ opacity: 0, y: 30 }}
// //         animate={{ opacity: 1, y: 0 }}
